...
* SubIndex 2 - TwiceValue<br>
*/
OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x6000[] = {
{ DEFTYPE_UNSIGNED8 , 0x8 , ACCESS_READ },
{ DEFTYPE_UNSIGNED32 , 0x20 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex1 - Counter */
{ DEFTYPE_UNSIGNED32 , 0x20 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }}; /* Subindex2 - TwiceValue */
...
UINT32 TwiceValue; /* Subindex2 - TwiceValue */
} OBJ_STRUCT_PACKED_END
TOBJ6000;
#endif //#ifndef _DSPIC__SAMPLE_OBJECTS_H_
...
{ DEFTYPE_UNSIGNED32 , 0x20 , ACCESS_READWRITE | OBJACCESS_RXPDOMAPPING }}; /* Subindex2 - Value */
